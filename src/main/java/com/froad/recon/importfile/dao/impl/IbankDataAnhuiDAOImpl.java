...
public class IbankDataAnhuiDAOImpl extends HibernateBaseDao implements  IbankDataAnhuiDAO {
	...
	public IbankDataAnhui insert(IbankDataAnhui ibankDataAnhui) throws DBException {
		String id=GeneratorHelp.generateIbankDataAnhui();
		if (id!=null&&!"".equals(id)){
	        ibankDataAnhui.setOrderNo(id);
		}
		super.save(ibankDataAnhui);
		return ibankDataAnhui;
	}
	...
	public void batchInser (List<IbankDataAnhui> lists) throws DBException  {
		...
		for (int i = 0; i < lists.size(); i++) {
			String id=GeneratorHelp.generateIbankDataAnhui();
			IbankDataAnhui item=lists.get(i);
			if (id!=null&&!"".equals(id)){
		        item.setOrderNo(id);
	...
	public IbankDataAnhui getById(String objID) {
		return  (IbankDataAnhui)super.getHibernateTemplate().get(IbankDataAnhui.class, objID);
	}
	 ...
	 */
	public List getAll(){
		return  getHibernateTemplate().findByExample(new IbankDataAnhui());
	}
	...
	public List getList(IbankDataAnhui ibankDataAnhui) {
		return  getHibernateTemplate().findByExample(ibankDataAnhui);
	}
	...
	public List<IbankDataAnhui> selectForPagin(Map<String, Object> paramsMap, Integer pageNum, Integer pageSize) 
		...
		List<IbankDataAnhui> list = this.findByPaged(hql, params.toArray(), pageNum, pageSize);
		if (list == null || list.size() == 0) {
			return new ArrayList<IbankDataAnhui>();
		}
		return list;
	}
	...
	private String createHql(Map<String, Object> paramsMap,
		...
		hql.append("from IbankDataAnhui t where 1=1");
