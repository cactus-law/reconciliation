 ...
 * @since   JDK1.6
 */
public class DataDealProcessorPayRefund implements DataDealProcessor {
	
	final static Logger logger = LoggerFactory.getLogger(DataDealProcessorPayRefund.class);
	@Autowired
	...
	public Map<String, Object> execute(Map<String, Object> reqMap) throws Exception {
		...
		paramsMap.put("c.pay_time_max", DateUtil.getDateFromStringN(reconDate+"235959", DateUtil.anotherByte14Format));
		paramsMap.put("c.pay_time_min", DateUtil.getDateFromStringN(reconDate+"000000", DateUtil.anotherByte14Format));
		List<Map<String,Object>> dataList = queryService.queryPayRefundsTrade(paramsMap);
