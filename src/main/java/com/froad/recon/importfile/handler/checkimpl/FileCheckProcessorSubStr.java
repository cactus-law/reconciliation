 ...
 *
 */
public class FileCheckProcessorSubStr implements FileCheckProcessor {

	final static Logger logger = LoggerFactory.getLogger(FileCheckProcessorSubStr.class);
	...
	public Map<String, Object> execute(Map<String, Object> reqMap) {
		...
		//检查对账数据
		int rows = FileUtil.checkContent(filePath, 56, 66);
		//判断文件内容
		if(rows<0){
