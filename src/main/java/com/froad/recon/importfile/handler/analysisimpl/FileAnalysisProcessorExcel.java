 ...
 *
 */
public class FileAnalysisProcessorExcel implements FileAnalysisProcessor {
	
	final static Logger logger = LoggerFactory.getLogger(FileAnalysisProcessorExcel.class);
	...
	public Map<String,Object> execute(Map<String,Object> reqMap) throws FlowException {
		...
		try {
			...
			dataRule.setRuleType(BusinessConstant.RULE_TYPE.EXCEL);
