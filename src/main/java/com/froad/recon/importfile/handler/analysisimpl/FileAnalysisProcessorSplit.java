 ...
 *
 */
public class FileAnalysisProcessorSplit implements FileAnalysisProcessor {
	
	final static Logger logger = LoggerFactory.getLogger(FileAnalysisProcessorSplit.class);
