...
import com.froad.recon.importfile.dao.impl.IfrontTradeDAOImpl;
 ...
 *
 * @author zhangjwei
 * @created 2015-06-16 11:07:19
 * @version 1.0
 */

public class IfrontTradeServiceImpl implements IfrontTradeService{
	private final static Logger logger = Logger.getLogger(IfrontTradeDAOImpl.class);
	private IfrontTradeDAO ifrontTradeDAO;
	public IfrontTradeDAO getifrontTradeDAO() {
		return ifrontTradeDAO;
	}
	public void setifrontTradeDAO(IfrontTradeDAO ifrontTradeDAO) {
		this.ifrontTradeDAO = ifrontTradeDAO;
	}
	...
	public IfrontTrade insert(IfrontTrade ifrontTrade) throws ServiceException{
		try {
			return ifrontTradeDAO.insert(ifrontTrade);
		} catch (DBException e) {
			logger.error(e);
	...
	public void batchInser(List<IfrontTrade> lists) throws ServiceException{
		try {
			ifrontTradeDAO.batchInser(lists);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		}catch (Exception e) {
	...
	public void delete(IfrontTrade ifrontTrade) throws ServiceException {
		try {
			ifrontTradeDAO.delete(ifrontTrade);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		}catch (Exception e) {
	...
	public void batchDelete(List<IfrontTrade> lists) throws ServiceException {
		try {
			ifrontTradeDAO.batchDelete(lists);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		}catch (Exception e) {
	...
	public void update(IfrontTrade ifrontTrade) throws ServiceException{
		try {
			ifrontTradeDAO.update(ifrontTrade);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		}catch (Exception e) {
	...
	public void batchUpdate(List<IfrontTrade> lists) throws ServiceException {
		try {
			ifrontTradeDAO.batchUpdate(lists);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		} catch (Exception e) {
	...
	public IfrontTrade getById(String objID) throws ServiceException {
		try {
			return ifrontTradeDAO.getById(objID);
		} catch (Exception e) {
			logger.error(e);
			throw new ServiceException(null,e.getMessage(),e);
		}
	...
	public List<IfrontTrade> getByOrderNos(List<String> orderNos)  throws ServiceException {
		try {
			...
			paramsMap.put("orderNo_in", orderNos);
			return ifrontTradeDAO.selectMap(paramsMap);
		} catch (Exception e) {
			logger.error(e);
			throw new ServiceException(null,e.getMessage(),e);
		}
	...
	public List getList(IfrontTrade ifrontTrade) throws ServiceException{
		try {
			return ifrontTradeDAO.getList(ifrontTrade);
		} catch (Exception e) {
			logger.error(e);
			throw new ServiceException(null,e.getMessage(),e);
		}
	...
	public List<IfrontTrade> selectForPagin(Map<String, Object> paramsMap, Integer pageNum, Integer pageSize) 
			throws ServiceException{
		try {
			return ifrontTradeDAO.selectForPagin(paramsMap, pageNum, pageSize);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		} catch (Exception e) {
	...
	public Integer selectForPaginCount(Map<String, Object> paramsMap) throws ServiceException{
		try {
			return ifrontTradeDAO.selectForPaginCount(paramsMap);
		} catch (DBException e) {
			logger.error(e);
			throw new ServiceException(e.getErrorCode(),e.getErrorMsg(),e);
		} catch (Exception e) {
